...
Before you contribute, we first ask people to sign a [Contributor License Agreement](https://www.clahub.com/agreements/CognizantQAHub/Cognizant-Intelligent-Test-Scripter-IE-Toolbar) (or CLA). We ask this so that we know that contributors have the right to donate the code.
